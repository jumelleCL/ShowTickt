                    ...
                    <div class="event-card">
                        <div class="event-details">
                            ...
                            <div class="buttons">
                                ...
                                <a href="{{ route('administrar-esdeveniment', ['id' => $sessio->esdeveniment->id]) }}"
                                ...
                                <a href="{{ route('llistats-entrades', ['id' => $sessio->id]) }}"
                                ...
                                <a href="{{ route('exportar-entrades', ['sessioId' => $sessio->id]) }}"
                        ...
                        <img src="{{ Storage::url('public/images/' . $sessio->esdeveniment->imatge->first()->imatge) }}"
                            alt="Imatge de l'esdeveniment" loading="lazy">
                    </div>
                </div>
            @endforeach
        </div>
        <div class="pages">{{ $sesiones->links('pagination::bootstrap-5') }}</div>
    @endif
@endsection
