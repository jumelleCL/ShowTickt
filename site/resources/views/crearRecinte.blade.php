...
@section('content')
    <div id="content-container">
        <form action="{{ route('recinte-nou') }}" method="GET" id="nousCamps" class="addEvent" style="display: block;">
            <div class="form-group">
                <label for="nova_nom" class="form-label">Nombre del Local</label>
                <input type="text" maxlength="50" class="form-controller" id="nova_nom" name="nova_nom" value="{{ old('nova_nom') }}">
            </div>
