        ...
        <div class="textEvent">
            ...
            <div class="form-select" id="fechaDiv" name="fecha" style="display: none;">
                ...
                <?php $__currentLoopData = $fechas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fecha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="fecha">
                        <form action="<?php echo e(route('editarSesion')); ?>" method="GET" class="SessionEditar">
                        ...
                        <?php if($fecha->estado != true): ?>
                            <form action="<?php echo e(route('abrirSesion')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="eventoId" value="<?php echo e($esdeveniment->id); ?>">
                                <input type="hidden" name="fechaId" value="<?php echo e($fecha->id); ?>">
                        ...
                        <?php else: ?>
                            <form action="<?php echo e(route('cerrarSesion')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="eventoId" value="<?php echo e($esdeveniment->id); ?>">
                                <input type="hidden" name="fechaId" value="<?php echo e($fecha->id); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alexg\OneDrive\Documentos\Projecte 2\gr6-arrua-galindo-jumelle\site\resources\views/editarEsdeveniment.blade.php ENDPATH**/ ?>